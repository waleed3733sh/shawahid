    ...
    <div className="max-w-4xl">
      <div className="bg-white border border-slate-100 rounded-2xl p-8 mb-6">
        <div className="flex flex-wrap items-center justify-between gap-4 pb-6 border-b border-slate-100">
          ...
          <div className="w-14 h-14 rounded-2xl bg-navy-800 text-gold-500 grid place-items-center font-display text-xl font-extrabold">
            ش
          </div>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
          {cards.map(([l, v]) => (
            <div key={l} className="bg-mist rounded-xl p-4 text-center">
              <div className="font-display text-2xl font-extrabold text-navy-800">
                {v}
              </div>
      ...
      {pending.length ? (
        ...
        <div className="bg-white border border-slate-100 rounded-2xl p-6 text-center text-green-700 font-bold">
