    ...
    <div className="max-w-3xl">
      <div className="bg-white border border-gray-100 rounded-2xl p-6 lg:p-8">
        <div className="flex items-center gap-4 mb-8 pb-6 border-b border-gray-100">
          <div className="w-16 h-16 rounded-2xl bg-forest-800 text-gold-500 grid place-items-center font-display text-2xl font-extrabold">
            ش
          </div>
          <div>
        ...
        <button
          onClick={save}
          className="mt-8 bg-forest-800 hover:bg-forest-700 text-white font-bold px-6 py-3 rounded-xl"
        >
