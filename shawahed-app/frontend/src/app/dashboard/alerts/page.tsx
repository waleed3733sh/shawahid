...
export default function AlertsPage() {
  ...
  return (
    <div className="max-w-3xl space-y-4">
      {thisWeek && (
        <div className="rounded-2xl p-6 bg-gradient-to-l from-forest-800 to-forest-700 text-white">
          ...
          <Link
            ...
            className="inline-block mt-4 bg-gold-500 text-forest-900 font-bold px-4 py-2 rounded-xl text-sm"
          >
            رفع شاهد البند ←
          </Link>
        </div>
